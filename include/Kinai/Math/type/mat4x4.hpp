...
// template<typename T>
// constexpr mat<4, 4, T>::mat(mat<4, 4, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(T const& s)
...
template<typename T>
constexpr mat<4, 4, T>::mat(col_type const& v0, col_type const& v1, col_type const& v2, col_type const& v3)
...
template<typename T>
template<typename V1, typename V2, typename V3, typename V4>
constexpr mat<4, 4, T>::mat(vec<4, V1> const& v1, vec<4, V2> const& v2, vec<4, V3> const& v3, vec<4, V4> const& v4)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<2, 2, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<3, 3, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<2, 3, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<3, 2, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<2, 4, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<4, 2, T> const& m)
	: value{col_type(m[0], 0, 0), col_type(m[1], 0, 0), col_type(0, 0, 1, 0), col_type(0, 0, 0, 1)}
{
	this->value[0] = col_type(m[0], 0, 0);
		this->value[1] = col_type(m[1], 0, 0);
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<3, 4, T> const& m)
...
template<typename T>
constexpr mat<4, 4, T>::mat(mat<4, 3, T> const& m)
...
template<typename T>
constexpr typename mat<4, 4, T>::col_type const& mat<4, 4, T>::operator[](typename mat<4, 4, T>::length_type i) const
{
	assert(i < this->length());
	return this->value[i];
}
...
template<typename T>
template<typename U>
mat<4, 4, T>& mat<4, 4, T>::operator=(mat<4, 4, U> const& m)
{
...
template<typename T>
template<typename U>
mat<4, 4, T>& mat<4, 4, T>::operator+=(U s)
{
	this->value[0] += s;
	this->value[1] += s;
	this->value[2] += s;
...
template<typename T>
mat<4, 4, T> mat<4, 4, T>::operator++(int)
{
...
template<typename T>
typename mat<4, 4, T>::row_type operator*
(
