...
template<typename T>
inline mat<4, 4, T> rotate_slow(mat<4, 4, T> const& m, T angle, vec<3, T> const& v)
{
	T const a = angle;
	T const c = cos(a);
	T const s = sin(a);
...
template<typename T>
inline mat<4, 4, T> scale_slow(mat<4, 4, T> const& m, vec<3, T> const& v)
{
...
template<typename T>
inline mat<4, 4, T> lookAtRH(vec<3, T> const& eye, vec<3, T> const& center, vec<3, T> const& up)
{
...
template<typename T>
inline mat<4, 4, T> lookAtLH(vec<3, T> const& eye, vec<3, T> const& center, vec<3, T> const& up)
{
	vec<3, T> const f(normalize(center - eye));
...
template<typename T>
inline mat<4, 4, T> lookAt(vec<3, T> const& eye, vec<3, T> const& center, vec<3, T> const& up)
{
