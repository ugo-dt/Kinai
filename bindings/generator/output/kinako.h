...
void KnBufferElement_BufferElement(KnShaderDataType type, void* name, bool normalized);
uint32_t KnBufferElement_GetComponentCount();
void KnBufferLayout_BufferLayout();
void KnBufferLayout_BufferLayout(KnBufferElement* elements);
void KnBufferLayout_BufferLayout(const KnBufferElement* elements);
...
void KnCamera_Camera(const mat4s* projection_matrix);
...
void KnFramebufferAttachmentConfig_FramebufferAttachmentConfig(KnFramebufferTextureConfig* attachments);

void KnFramebufferTextureConfig_FramebufferTextureConfig();
void KnFramebufferTextureConfig_FramebufferTextureConfig(KnFramebufferTextureFormat format);
...
const KnOrthographicCamera* KnOrthographicCameraController_GetCamera();
...
KN_INLINE bool KnParser_iterator_equals(void** it, const void** s);
void KnPerspectiveCamera_PerspectiveCamera();
void KnPerspectiveCamera_PerspectiveCamera(float viewport_width, float viewport_height, float fov, float near_clip, float far_clip);
...
const KnPerspectiveCamera* KnPerspectiveCameraController_GetCamera();
...
void KnRenderCommand_SetClearColor(float r, float g, float b, float a);
void KnRenderCommand_SetClearColor(uint8_t r, uint8_t g, uint8_t b, uint8_t a);
...
void KnRenderer2D_BeginFrame(const KnOrthographicCamera* camera);
void KnRenderer2D_BeginFrame(const KnPerspectiveCamera* camera);
...
void KnRenderer2D_DrawQuad(const vec3s* position, const vec2s* size, const vec4s* color);
void KnRenderer2D_DrawQuad(const vec2s* position, const vec2s* size, const KnTexture2D* texture, const vec4s* tint_color);
void KnRenderer2D_DrawQuad(const vec3s* position, const vec2s* size, const KnTexture2D* texture, const vec4s* tint_color);
void KnRenderer2D_DrawQuad(const vec2s* position, const vec2s* size, const KnTexture2D* texture, const vec2s* uvStart, const vec2s* uvEnd, const vec4s* tint_color);
void KnRenderer2D_DrawQuad(const vec3s* position, const vec2s* size, const KnTexture2D* texture, const vec2s* uvStart, const vec2s* uvEnd, const vec4s* tint_color);
void KnRenderer2D_DrawQuad(const mat4s* transform, const vec4s* color);
void KnRenderer2D_DrawQuad(const mat4s* transform, const KnTexture2D* texture);
void KnRenderer2D_DrawQuad(const mat4s* transform, const KnTexture2D* texture, const vec2s* uvStart, const vec2s* uvEnd, const vec4s* tint_color);
void KnRenderer2D_DrawRotatedQuad(const vec2s* position, const vec2s* size, float rotation, const vec4s* color);
void KnRenderer2D_DrawRotatedQuad(const vec3s* position, const vec2s* size, float rotation, const vec4s* color);
void KnRenderer2D_DrawRotatedQuad(const vec2s* position, const vec2s* size, float rotation, const KnTexture2D* texture, const vec4s* tintColor);
void KnRenderer2D_DrawRotatedQuad(const vec3s* position, const vec2s* size, float rotation, const KnTexture2D* texture, const vec4s* tintColor);
void KnRenderer2D_DrawRect(const vec3s* position, const vec2s* size, const vec4s* color);
void KnRenderer2D_DrawRect(const mat4s* transform, const vec4s* color);
...
KnShader* KnShader_Create(void* name, void* vertexSrc, void* fragmentSrc);
KnShader* KnRenderer2D::Shader2D_GetShader();

void KnShaderLibrary_Add(void* name, const KnShader* shader);
void KnShaderLibrary_Add(const KnShader* shader);
KnShader* KnShaderLibrary_Load(void* filepath, void* name);
KnShader* KnShaderLibrary_Load(void* name, void* vertexSrc, void* fragmentSrc);
...
bool KnTexture_operator==(const KnTexture* other);
KnTexture2D* KnTexture2D_Create(const KnTextureConfig* config);
KnTexture2D* KnTexture2D_Create(void* path, GLenum min_filter, GLenum max_filter);
...
KnVertexBuffer* KnVertexBuffer_Create(const void* vertices, uint32_t size);
