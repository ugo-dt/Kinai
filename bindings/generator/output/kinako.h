...
KnShader* KnRenderer2D_Shader2D_GetShader();
...
uint32_t KnRenderer2D_Statistics_GetTotalVertexCount();
uint32_t KnRenderer2D_Statistics_GetTotalIndexCount();
void KnRenderer2D_Statistics_Reset();
uint32_t KnRenderer2D_Statistics_GetDrawCalls();
uint32_t KnRenderer2D_Statistics_GetQuadCount();
